...
function FeaturesSection() {
  const featuresMenu = [
    {
      icon: (
        <FaHouseDamage className="w-15 h-15 md:w-20 md:h-20 p-3 rounded-full bg-yellow-100 text-yellow-600" />
      ),
    ...
    {
      icon: (
        <FaShieldAlt className="w-15 h-15 md:w-20 md:h-20 p-3 rounded-full bg-orange-100 text-orange-600" />
      ),
    ...
    {
      icon: (
        <SlEnergy className="w-15 h-15 md:w-20 md:h-20 p-3 rounded-full bg-slate-100 text-silver-600" />
      ),
      name: "Save Energy",
    ...
    {
      icon: (
        <IoIosPhonePortrait className="w-15 h-15 md:w-20 md:h-20 p-3 rounded-full bg-green-100 text-green-600" />
      ),
  ...
  return (
    <>
      <section className="space-y-5 text-slate-600 mt-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-10 px-5">
